...
var Sector = exports.Sector = /** @class */function (_super) {
  ...
  Sector.prototype.setAttribute = function (name, value, force) {
    ...
    if (['startAngle', 'endAngle', 'r', 'r0', 'radius', 'cx', 'cy', 'padAngle'].indexOf(name) > -1) {
      this.updatePath();
    }
  };
  Sector.prototype.updatePath = function () {
    var _a = this.parsedStyle,
      ...
      _c = _a.padAngle,
      padAngle = _c === void 0 ? 0 : _c;
    if ((0, _util2.isNil)(startAngle) || (0, _util2.isNil)(endAngle) || startAngle === endAngle || (0, _util2.isNil)(r) || r <= 0) {
      _super.prototype.setAttribute.call(this, 'path', '');
      return;
    }
    var startRad = (0, _gLite.deg2rad)(startAngle);
    var endRad = (0, _gLite.deg2rad)(endAngle);
    var padRad = (0, _gLite.deg2rad)(padAngle);
    var adjStart = startRad;
    var adjEnd = endRad;
    if (padRad > 0) {
      var clockwise = !anticlockwise;
      var rawAngle = clockwise ? endRad - startRad : startRad - endRad;
    ...
    var path = this.createPath(cx, cy, adjStart, adjEnd, r, r0 ? r0 : 0, radius ? radius : [0, 0, 0, 0], anticlockwise);
  ...
  Sector.prototype.createPath = function (x, y, startAngle, endAngle, r, r0, borderRadius, anticlockwise) {
    var start = (0, _util.polarToCartesian)(x, y, r, startAngle);
    var end = (0, _util.polarToCartesian)(x, y, r, endAngle);
    var innerStart = (0, _util.polarToCartesian)(x, y, r0, startAngle);
    var innerEnd = (0, _util.polarToCartesian)(x, y, r0, endAngle);
    var clockwise = !anticlockwise;
    var angle = clockwise ? endAngle - startAngle : startAngle - endAngle;
    // 整圆
    if (Math.abs(angle) >= PI2 || (0, _util2.isNumberEqual)(Math.abs(angle), PI2)) {
      // 整个圆是分割成两个圆
      var middlePoint = (0, _util.polarToCartesian)(x, y, r, startAngle + Math.PI);
      var innerMiddlePoint = (0, _util.polarToCartesian)(x, y, r0, startAngle + Math.PI);
    ...
    if (limitedOutBorderRadiusMax > e) {
      ...
      if (limitedOutBorderRadiusMax < outBorderRadiusMax && crStart === crEnd) {
        ...
        if (crStart > 0) {
          ...
          var outStartBorderRadiusEndPoint = (0, _util.polarToCartesian)(x, y, r, outStartBorderRadiusEndAngle);
        ...
        var outRadiusEndPoint = (0, _util.polarToCartesian)(x, y, r, outRadiusEndAngle);
    ...
    if (r0 < e) {
      ...
      if (limitedInnerBorderRadiusMax < innerBorderRadiusMax && crStart === crEnd) {
        ...
        var innerRadiusEndPoint = (0, _util.polarToCartesian)(x, y, r0, innerRadiusEndAngle);
