  ...
  return /** @class */function (_super) {
    ...
    Axis.prototype.calculateLabelOverflow = function (lastTick) {
      ...
      var _b = lastTick.labelStyle,
        ...
        text = lastTick.text;
      var tickBBox = measureText(labelStyle.text || text, (0, _tslib.__assign)((0, _tslib.__assign)({}, label), labelStyle));
      var lastTickPoint = coord.convertPoint({
        x: lastTick.value,
        y: 0
      });
      var labelRightEdge = lastTickPoint.x;
      var _c = (0, _tslib.__assign)((0, _tslib.__assign)({}, label), labelStyle).align,
