...
var Chart = /** @class */function (_super) {
  ...
  Chart.prototype.highlight = function (field, condition) {
    var _a;
    if (condition === null) {
      this.setState({
        highlights: {}
    ...
    this.setState({
      highlights: (_a = {}, _a[field] = condition, _a)
    });
  };
  ...
  Chart.prototype.getHighlightStyle = function (record) {
    var highlights = this.state.highlights;
    var isHighLight = false;
    if ((0, _util.isEmpty)(highlights)) return;
