  ...
  return /** @class */function (_super) {
    ...
    function Legend(props) {
      ...
      _this._onclick = function (item) {
        ...
        var _e = _this.state,
          prevFiltered = _e.filtered,
          preHighlighted = _e.highlighted;
        ...
        if (clickMode === 'filter') {
          ...
          var highlighted_1 = (_b = {}, _b[tickValue] = !preHighlighted[tickValue], _b);
          _this.setState({
            highlighted: highlighted_1
          });
          chart.highlight(field, preHighlighted[tickValue] ? null : function (value) {
            return highlighted_1[value];
          });
        }
      };
      _this.state = {
