...
__DEFINE__(1769150026233, function(require, module, exports) {
...
var Camera = /** @class */ (function () {
    ...
    Camera.prototype.setPerspective = function (near, far, fov, aspect) {
        ...
        makePerspective(this.projectionMatrix, left, left + width, top, top - height, near, this.far, this.clipSpaceNearZ === exports.ClipSpaceNearZ.ZERO);
    ...
    Camera.prototype.setOrthographic = function (l, r, t, b, near, far) {
        ...
        if (this.clipSpaceNearZ === exports.ClipSpaceNearZ.NEGATIVE_ONE) {
            ...
            glMatrix.mat4.orthoZO(this.projectionMatrix, left, right, bottom, top, near, far);
        }
        // flipY since the origin of OpenGL/WebGL is bottom-left compared with top-left in Canvas2D
        glMatrix.mat4.scale(this.projectionMatrix, this.projectionMatrix, glMatrix.vec3.fromValues(1, -1, 1));
        glMatrix.mat4.invert(this.projectionMatrixInverse, this.projectionMatrix);
...
function parsePoints(pointsOrStr, object) {
    ...
    var segmentT;
    var segmentL;
    var totalLength = gMath.polylineLength(points);
...
var DefaultStyleValueRegistry = /** @class */ (function () {
    ...
    DefaultStyleValueRegistry.prototype.processProperties = function (object, attributes, options) {
        ...
        if (!this.runtime.enableCSSParsing) {
            ...
            // @ts-ignore
            if (attributes.path === '') {
                object.parsedStyle.path = tslib.__assign({}, EMPTY_PARSED_PATH);
            }
            // @ts-ignore
            if (attributes.path) {
            ...
            if (
            // Circle & Ellipse
            ((object.nodeName === exports.Shape.CIRCLE ||
                object.nodeName === exports.Shape.ELLIPSE) &&
                // @ts-ignore
                (!util.isNil(attributes.cx) ||
                    // @ts-ignore
                    !util.isNil(attributes.cy))) ||
                ((object.nodeName === exports.Shape.RECT ||
                    object.nodeName === exports.Shape.IMAGE ||
                    object.nodeName === exports.Shape.GROUP ||
                    object.nodeName === exports.Shape.HTML ||
                    object.nodeName === exports.Shape.TEXT ||
                    object.nodeName === exports.Shape.MESH) &&
                    // @ts-ignore
    ...
    DefaultStyleValueRegistry.prototype.updateGeometry = function (object) {
        ...
        if (geometryUpdater) {
            ...
            else if (nodeName === exports.Shape.MESH) {
...
function parsedTransformToMat4(transform, object) {
    ...
    transform.forEach(function (parsed) {
        ...
        if (t === 'scale') {
            ...
            // @ts-ignore
            glMatrix.mat4.set.apply(glMatrix.mat4, tslib.__spreadArray([tmpMat4], tslib.__read(d.map(function (s) { return s.value; })), false));
            tmpMat4[12] += defX;
            tmpMat4[13] += defY;
...
var CSSPropertyLocalPosition = /** @class */ (function (_super) {
    tslib.__extends(CSSPropertyLocalPosition, _super);
    ...
    CSSPropertyLocalPosition.prototype.postProcessor = function (object, attributes) {
        ...
        switch (object.nodeName) {
            ...
            case exports.Shape.MESH:
                ...
                if (!util.isNil(object.parsedStyle.z)) {
                    z = object.parsedStyle.z;
                }
                break;
        }
        if (object.nodeName !== exports.Shape.PATH &&
            object.nodeName !== exports.Shape.POLYLINE &&
            object.nodeName !== exports.Shape.POLYGON) {
        ...
        if (needResetLocalPosition && attributes.indexOf('transform') === -1) {
            ...
            if (transform && transform.length) {
                ...
                var _c = tslib.__read(object.getLocalPosition(), 3), ox = _c[0], oy = _c[1], oz = _c[2];
...
var CSSPropertyPoints = /** @class */ (function () {
    ...
    CSSPropertyPoints.prototype.postProcessor = function (object, attributes) {
        if ((object.nodeName === exports.Shape.POLYGON ||
            object.nodeName === exports.Shape.POLYLINE) &&
            attributes.indexOf('transform') === -1) {
...
var geometryUpdaterFactory = (function () {
    ...
    return _a = {},
        ...
        _a[exports.Shape.GROUP] = rectUpdater,
...
var CSSPropertySyntaxFactory = (function () {
    ...
    return _a = {},
        ...
        _a[exports.PropertySyntax.COORDINATE] = new CSSPropertyLocalPosition(),
...
var DEFAULT_PARSED_STYLE_PROPS_CSS_DISABLED = tslib.__assign(tslib.__assign({}, DEFAULT_PARSED_STYLE_PROPS), { opacity: 1, fillOpacity: 1, strokeOpacity: 1, visibility: 'visible', pointerEvents: 'auto', lineWidth: 1, lineCap: 'butt', lineJoin: 'miter', increasedLineWidthForHitTesting: 0, fillRule: 'nonzero' });
...
var DisplayObject = /** @class */ (function (_super) {
    ...
    DisplayObject.prototype.setAttribute = function (name, value, force, memoize) {
        ...
        if (force || value !== this.attributes[attributeName]) {
            this.internalSetAttribute(attributeName, value, { memoize: memoize });
...
var Circle = /** @class */ (function (_super) {
    ...
    function Circle(_a) {
        ...
        return _super.call(this, tslib.__assign({ type: exports.Shape.CIRCLE, style: runtime.enableCSSParsing
                ? tslib.__assign({ cx: '', cy: '', r: '' }, style) : tslib.__assign({}, style), initialParsedStyle: {
                anchor: [0.5, 0.5],
...
var CustomElement = /** @class */ (function (_super) {
    ...
    function CustomElement(_a) {
        ...
        _this = _super.call(this, tslib.__assign({ style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '' }, style) : tslib.__assign({}, style) }, rest)) || this;
...
var Ellipse = /** @class */ (function (_super) {
    ...
    function Ellipse(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.ELLIPSE, style: runtime.enableCSSParsing
                ? tslib.__assign({ cx: '', cy: '', rx: '', ry: '' }, style) : tslib.__assign({}, style), initialParsedStyle: {
                anchor: [0.5, 0.5],
                transformOrigin: runtime.enableCSSParsing
                    ? null
                    : [PECENTAGE_50, PECENTAGE_50],
...
var Group = /** @class */ (function (_super) {
    ...
    function Group(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.GROUP, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', width: '', height: '' }, style) : tslib.__assign({}, style) }, rest)) || this;
    }
    return Group;
}(DisplayObject));
...
var Image = /** @class */ (function (_super) {
    ...
    function Image(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.IMAGE, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', img: '', width: '', height: '' }, style) : tslib.__assign({}, style) }, rest)) || this;
    }
    return Image;
}(DisplayObject));
...
var Path = /** @class */ (function (_super) {
    ...
    function Path(_a) {
        ...
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.PATH, style: runtime.enableCSSParsing
                ? tslib.__assign({ path: '', miterLimit: '' }, style) : tslib.__assign({}, style), initialParsedStyle: runtime.enableCSSParsing
                ? null
                : {
                    miterLimit: 4,
                    path: tslib.__assign({}, EMPTY_PARSED_PATH),
                } }, rest)) || this;
        _this.markerStartAngle = 0;
        _this.markerEndAngle = 0;
        /**
    ...
    Path.prototype.placeMarkerMid = function (marker) {
        ...
        if (marker && isDisplayObject(marker)) {
            for (var i = 1; i < segments.length - 1; i++) {
                var _b = tslib.__read(segments[i].currentPoint, 2), ox = _b[0], oy = _b[1];
    ...
    Path.prototype.getPointAtLength = function (distance, inWorldSpace) {
        ...
        var _b = util.getPointAtLength(absolutePath, distance), x = _b.x, y = _b.y;
        var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x - defX, y - defY, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
        // apply local transformation
        return new Point(transformed[0], transformed[1]);
    };
...
var Polyline = /** @class */ (function (_super) {
    ...
    Polyline.prototype.getPoint = function (ratio, inWorldSpace) {
        ...
        var _c = gMath.linePointAt(points[index][0], points[index][1], points[index + 1][0], points[index + 1][1], subt), x = _c.x, y = _c.y;
        var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x - defX, y - defY, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
        // apply local transformation
        return new Point(transformed[0], transformed[1]);
    };
...
var Rect = /** @class */ (function (_super) {
    ...
    function Rect(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.RECT, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', width: '', height: '', radius: '' }, style) : tslib.__assign({}, style) }, rest)) || this;
    }
    return Rect;
}(DisplayObject));
    ...
    function Text(_a) {
        ...
        return _super.call(this, tslib.__assign({ type: exports.Shape.TEXT, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', text: '', fontSize: '', fontFamily: '', fontStyle: '', fontWeight: '', fontVariant: '', textAlign: '', textBaseline: '', textTransform: '', fill: 'black', letterSpacing: '', lineHeight: '', miterLimit: '', 
                    // whiteSpace: 'pre',
                    wordWrap: false, wordWrapWidth: 0, leading: 0, dx: '', dy: '' }, style) : tslib.__assign({ fill: 'black' }, style), initialParsedStyle: runtime.enableCSSParsing
                ? {}
                : {
                    x: 0,
                    y: 0,
...
return __REQUIRE__(1769150026233);
})()
//miniprogram-npm-outsideDeps=["tslib","eventemitter3","gl-matrix","@antv/util","d3-color","@antv/g-math"]
//# sourceMappingURL=index.js.map